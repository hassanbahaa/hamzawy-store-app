    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          contentPadding: sharedLang == 'en'
              ? EdgeInsets.only(top:  Dimensions.height5, bottom:  Dimensions.height5, left:  Dimensions.height10, right: 0)
              : EdgeInsets.only(top:  Dimensions.height5, bottom:  Dimensions.height5, left: 0, right:  Dimensions.height10),
          hintText: hint,
          hintStyle: TextStyle(fontSize:  Dimensions.fontSize12),
          label: Text(label,style: TextStyle(fontSize: Dimensions.fontSize14),),
